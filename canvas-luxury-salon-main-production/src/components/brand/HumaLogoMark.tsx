...
/** Compact ornate monogram — circle H with gold flourishes (matches full logo). */
export function HumaLogoMark({
  ...
  return (
    ...
    >
      <title>{title}</title>
      <defs>
        <linearGradient id="huma-mark-gold" x1="8" y1="6" x2="64" y2="66">
      ...
      <circle cx="36" cy="36" r="26" fill="#0a0a0a" stroke="url(#huma-mark-gold)" strokeWidth="1.6" />
      <circle cx="36" cy="36" r="22" stroke="#c9a962" strokeWidth="0.55" opacity="0.4" />

      <path
        d="M24 24 V48 M48 24 V48"
        stroke="url(#huma-mark-gold)"
        strokeWidth="2.8"
        strokeLinecap="round"
      />
      <path
